...
export class DeliveryPartnerSignInComponent {
  constructor(public objservice : DelpartnerdtologinService, private http : HttpClient, private router : Router, private tokenservice : TokenserviceService, private location:Location )
{
}
