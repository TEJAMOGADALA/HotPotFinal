...
export class ResOwnerSignInComponent {
  constructor(public objservice : ResdtologinService, private http : HttpClient, private router : Router, private tokenservice : TokenserviceService, private location:Location )
  {
  }
  ngOnInit(): void {
